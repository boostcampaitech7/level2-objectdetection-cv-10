...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            ...
            data_root = root,
            ann_file= 'folds/train_fold2.json',
...
val_evaluator = dict(
    metric='bbox',
    ann_file= root + 'folds/val_fold2.json')
...
param_scheduler = [
    dict(
        ...
        T_max=max_epochs,  # 전체 에포크 수에 맞게 설정
        eta_min=1e-6  # 최소 학습률
    )
]
...
vis_backends = [
    ...
    dict(type='WandbVisBackend',
         init_kwargs={
            'project': 'MMDetectionv3',
            'name' : 'co_dino_5scale_r50_1x_coco-fold2_24epoch' 
         })
]
